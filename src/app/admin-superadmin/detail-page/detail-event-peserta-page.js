...
import DetailEventPesertaComponent from '../../../modules/admin-superadmin/detail-event/detail-event-peserta-component';


class DetailEventPesertaPage extends Component {
    state = {
        Event: [],
        kategori : [],
        detailEvent : [],
...
const page = connect(mapStateToProps, mapDispatchToProps)(DetailEventPesertaPage);
export default page