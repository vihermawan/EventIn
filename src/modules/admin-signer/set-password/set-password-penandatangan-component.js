...
const login = require(`../../../assets/images/set-password-signer.svg`);


class SetPasswordPenandatanganComponent extends Component{
    render(){
                                    ...
                                    <div className="form-set-password text-align-center">
                                        <Form onSubmit={handleSubmit}>
                                            <div className="set-password-form-container">
                                                <span className="auth-input-label text-set-password">Masukkan kata sandi anda</span>
                                                <InputPassword
                                                    name='password'
...
export default SetPasswordPenandatanganComponent;