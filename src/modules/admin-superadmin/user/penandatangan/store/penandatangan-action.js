...
const setIdDataPenandatangan = payload => ({
    type : actionType.SET_ID_PENANDATANGAN,
    payload,
});
...
export const setIdPenandatangan = (data) => (dispatch => {
    dispatch(setIdDataPenandatangan(data))
});
